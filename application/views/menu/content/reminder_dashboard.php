            ...
            <div class="row">
            	<div class="col-md-3 col-sm-3 col-xs-6">
                    <div class="dashboard-div-wrapper bk-clr-five">
                        <a href="<?php echo base_url('Reminder/create')?>">
                ...
                <div class="col-md-3 col-sm-3 col-xs-6">
                    <div class="dashboard-div-wrapper bk-clr-five">
                        <a href="<?php echo base_url('Reminder/create_jenis')?>">
                            <i  class="fa fa-calendar-plus-o dashboard-div-icon" ></i>
                        </a>                        
                        <div class="progress progress-striped active">
                        </div>
                        <h5>Buat Jenis Reminder</h5>
                    </div>
                </div>
                <div class="col-md-3 col-sm-3 col-xs-6">
                    <div class="dashboard-div-wrapper bk-clr-five">
                        <a href="<?php echo base_url('Reminder/cetak')?>">
